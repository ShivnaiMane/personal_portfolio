...
export const projects = [
  ...
  },
  {
    ...
    image: "",
    des: "Developed a doctor appointment platform with user registration, dynamic specialty-basedfiltering, and easy navigation between specialized doctor directories.Designed a platform where userscan view a specific doctor's appointment page, track the number of appointments booked, and access their profile with options to edit personaldetails seamlessly",
    deplyo_url: "https://book-appointment-mu.vercel.app/",
  },
  {
    id: "4",
    title: "STREAMLINE",
